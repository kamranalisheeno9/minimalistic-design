            ...
            return(
                ...
                <Card.Text >
                  ...
                  the card's content.
                    ...
                    <div className='mt-3'>
                    <Link to="/create">
                  <Button style={{width:"100%",textTransform:"uppercase",letterSpacing:"2px"}} variant="dark" onClick={()=>props.setCurrent(tournaments)} >Join</Button>
                    </Link>
                    </div>
                </Card.Text>
                </Card.Body>
